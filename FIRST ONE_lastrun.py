...
expName = 'FIRST ONE'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\asus\\Desktop\\PsychoPy cuz Im cool\\FIRST ONE.psyexp',
...
# Initialize components for Routine "instrukcje"
...
# ------Prepare to start Routine "instrukcje"-------
t = 0
instrukcjeClock.reset()  # clock
frameN = -1
...
# -------Ending Routine "instrukcje"-------
for thisComponent in instrukcjeComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "instrukcje" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        # *instrukcjewtrakcie* updates
        if t >= 0.0 and instrukcjewtrakcie.status == NOT_STARTED:
            # keep track of start time/frame for later
            instrukcjewtrakcie.tStart = t
            instrukcjewtrakcie.frameNStart = frameN  # exact frame index
